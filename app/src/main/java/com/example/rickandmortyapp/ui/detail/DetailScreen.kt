...
import com.example.rickandmortyapp.ui.detail.components.CharacterImage
import com.example.rickandmortyapp.ui.detail.components.DetailProperty
import com.example.rickandmortyapp.ui.detail.components.mirroringBackIcon
...
private fun Body(character: Character?){
    Column(
        ...
        DetailProperty(Label = stringResource(id = R.string.first_seen_in), value = character?.origin?.name, imageVector = Icons.Outlined.Visibility)
        DetailProperty(Label = stringResource(id = R.string.last_known_location), value = character?.location?.name, imageVector = Icons.Outlined.LocationOn)
    }
}
